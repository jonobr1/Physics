...
f=this.k1Forces[c];e=this.k2Forces[c];g=this.k3Forces[c];h=this.k4Forces[c];j=d.x+a/(6*b.mass)*(f.x+2*e.x+2*g.x+h.x);d=d.y+a/(6*b.mass)*(f.y+2*e.y+2*g.y+h.y);b.velocity.set(j,d)}},this);return this}});var D=Integrator=e,j=common,m=function(){this.__optimized=this.__equilibrium=!1;this.particles=[];this.springs=[];this.attractions=[];this.forces=[];this.integrator=new D(this);this.hasDeadParticles=!1;var a=arguments.length;1===a?(this.gravity=new l(0,arguments[0]),this.drag=m.DEFAULT_DRAG):2===a?(this.gravity=
new l(0,arguments[0]),this.drag=arguments[1]):3===a?(this.gravity=new l(arguments[0],arguments[1]),this.drag=arguments[3]):(this.gravity=new l(0,m.DEFAULT_GRAVITY),this.drag=m.DEFAULT_DRAG)};j.extend(m,{DEFAULT_GRAVITY:0,DEFAULT_DRAG:0.001,Attraction:C,Integrator:D,Particle:z,Spring:B,Vector:l});j.extend(m.prototype,{optimize:function(a){this.__optimized=!!a;return this},setGravity:function(a,b){this.gravity.set(a,b);return this},tick:function(){this.integrator.step(0===arguments.length?1:arguments[0]);
