 ...
 */
(function(){var e=Array.prototype,E=Object.prototype.hasOwnProperty,F=e.slice,u=e.forEach,v=e.indexOf,w=function(a,b,c){if(null!=a)if(u&&a.forEach===u)a.forEach(b,c);else if(a.length===+a.length)for(var d=0,i=a.length;d<i&&!(d in a&&b.call(c,a[d],d,a)===breaker);d++);else for(d in a)if(_.has(a,d)&&b.call(c,a[d],d,a)===breaker)break},x=function(a){return a},y=function(a,b,c){c||(c=x);for(var d=0,i=a.length;d<i;){var k=d+i>>1;c(a[k])<c(b)?d=k+1:i=k}return d};common={has:function(a,b){return E.call(a,
b)},each:w,extend:function(a){w(F.call(arguments,1),function(b){for(var c in b)a[c]=b[c]});return a},indexOf:function(a,b,c){if(null==a)return-1;var d;if(c)return c=y(a,b),a[c]===b?c:-1;if(v&&a.indexOf===v)return a.indexOf(b);c=0;for(d=a.length;c<d;c++)if(c in a&&a[c]===b)return c;return-1},sortedIndex:y,identity:x,isNumber:function(a){return"[object Number]"==toString.call(a)},isFunction:function(a){return"[object Function]"==toString.call(a)||"function"==typeof a},isUndefined:function(a){return void 0===
...
f=this.k1Forces[c];e=this.k2Forces[c];g=this.k3Forces[c];h=this.k4Forces[c];j=d.x+a/(6*b.mass)*(f.x+2*e.x+2*g.x+h.x);d=d.y+a/(6*b.mass)*(f.y+2*e.y+2*g.y+h.y);b.velocity.set(j,d)}},this);return this}});var D=Integrator=e,j=common,n=function(){this.__equilibrium=!1;this.particles=[];this.springs=[];this.attractions=[];this.forces=[];this.integrator=new D(this);this.hasDeadParticles=!1;var a=arguments.length;2===a?(this.gravity=new l(0,arguments[0]),this.drag=arguments[1]):3===a?(this.gravity=new l(arguments[0],
arguments[1]),this.drag=arguments[3]):(this.gravity=new l(0,n.DEFAULT_GRAVITY),this.drag=n.DEFAULT_DRAG)};j.extend(n,{DEFAULT_GRAVITY:0,DEFAULT_DRAG:0.001,Attraction:C,Integrator:D,Particle:z,Spring:B,Vector:l});j.extend(n.prototype,{setGravity:function(a,b){this.gravity.set(a,b);return this},tick:function(){this.integrator.step(0===arguments.length?1:arguments[0]);this.__equilibrium=!this.needsUpdate();return this},needsUpdate:function(){for(var a=0,b=this.particles.length;a<b;a++)if(!this.particles[a].resting())return!0;
a=0;for(b=this.springs.length;a<b;a++)if(!this.springs[a].resting())return!0;a=0;for(b=this.attractions.length;a<b;a++)if(!this.attractions[a].resting())return!0;return!1},addParticle:function(a){this.particles.push(a);return this},addSpring:function(a){this.springs.push(a);return this},addAttraction:function(a){this.attractions.push(a);return this},makeParticle:function(a,b,c){a=j.isNumber(a)?a:1;b=b||0;c=c||0;a=new z(a);a.position.set(b,c);this.addParticle(a);return a},makeSpring:function(a,b,c,
d,e){a=new B(a,b,c,d,e);this.addSpring(a);return a},makeAttraction:function(a,b,c,d){a=new C(a,b,c,d);this.addAttraction(a);return a},clear:function(){this.particles.length=0;this.springs.length=0;this.attractions.length=0},applyForces:function(){this.gravity.isZero()||j.each(this.particles,function(a){a.force.addSelf(this.gravity)},this);var a=new l;j.each(this.particles,function(b){a.set(-1*b.velocity.x*this.drag,-1*b.velocity.y*this.drag);b.force.addSelf(a)},this);j.each(this.springs,function(a){a.update()});
j.each(this.attractions,function(a){a.update()});j.each(this.forces,function(a){a.update()});return this},clearForces:function(){j.each(this.particles,function(a){a.clear()});return this}});var q=ParticleSystem=n,H=requestAnimationFrame=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,1E3/60)},p=common,r=function(){var a=this;this.tick();p.each(this.animations,
function(a){a()});!this.__equilibrium&&this.playing&&H(function(){r.call(a)})},e=function(){this.playing=!1;q.apply(this,arguments);this.animations=[];r.call(this)};p.extend(e,q,{superclass:q});p.extend(e.prototype,q.prototype,{play:function(){if(this.playing)return this;this.playing=!0;this.__equilibrium=!1;r.call(this);return this},pause:function(){this.playing=!1;return this},toggle:function(){this.playing?this.pause():this.play();return this},onUpdate:function(a){if(0<=p.indexOf(this.animations,
a)||!p.isFunction(a))return this;this.animations.push(a);return this},update:function(){if(!this.__equilibrium)return this;this.__equilibrium=!1;this.playing&&r.call(this);return this}});this.Physics=Physics=e})();